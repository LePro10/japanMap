...
// WP3: Originale Proportionen; alte Speicher-IDs bleiben gültig.
interface Identity {
...
function identity(v: Identity): VehicleSpec {
 ...
 return makeSpec({ id:v.id, name:v.name, category:v.category, price:v.price, blurb:v.blurb, chassis,
  ...
  body:{ shape:v.shape, hullWidth:v.shape === 'openwheel' ? .64 : v.width-.20,
...
const TOUGE_SPEC = identity({"id": "touge", "name": "Kite S", "category": "Street", "price": 0, "mass": 1180, "power": 135, "length": 4.12, "width": 1.7, "height": 1.36, "wheelbase": 2.43, "track": 1.46, "radius": 0.3, "wheelWidth": 0.23, "cg": 0.5, "front": 0.52, "travel": 0.22, "lock": 35, "shape": "coupe", "paint": 14935775, "layout": "rwd", "grip": 0.95, "dirt": 0.7, "clearance": 0.16, "blurb": "Light nose, a progressive rear slide, and an easy catch."});
const PIP_SPEC = identity({"id": "pip", "name": "Pip 650", "category": "Street", "price": 3000, "mass": 820, "power": 70, "length": 3.18, "width": 1.5, "height": 1.6, "wheelbase": 2.12, "track": 1.26, "radius": 0.265, "wheelWidth": 0.2, "cg": 0.53, "front": 0.61, "travel": 0.23, "lock": 39, "shape": "hatch", "paint": 6401421, "layout": "fwd", "grip": 0.9, "dirt": 0.7, "clearance": 0.16, "blurb": "Tiny footprint. Quick turn-in and short, safe handbrake rotations."});
const TRUCK_SPEC = identity({"id": "truck", "name": "Skiff Mini", "category": "Utility", "price": 3600, "mass": 1080, "power": 78, "length": 3.58, "width": 1.54, "height": 1.77, "wheelbase": 2.24, "track": 1.29, "radius": 0.28, "wheelWidth": 0.22, "cg": 0.62, "front": 0.57, "travel": 0.32, "lock": 38, "shape": "truck", "paint": 15235389, "layout": "rwd", "grip": 0.78, "dirt": 0.75, "clearance": 0.24, "blurb": "Forward cab, empty bed, soft bounce. Pull through village lanes."});
const OFFROAD_SPEC = identity({"id": "offroad", "name": "Cairn 4", "category": "Utility", "price": 9000, "mass": 1880, "power": 145, "length": 3.94, "width": 1.88, "height": 1.89, "wheelbase": 2.4, "track": 1.6, "radius": 0.39, "wheelWidth": 0.28, "cg": 0.75, "front": 0.54, "travel": 0.42, "lock": 32, "shape": "suv", "paint": 13219724, "layout": "awd", "grip": 0.82, "dirt": 0.85, "clearance": 0.32, "blurb": "Heavy turn-in, tall tyres and long travel. Explore beyond the asphalt."});
const TORRENT_SPEC = identity({"id": "torrent", "name": "Torrent R", "category": "Sport", "price": 15000, "mass": 1320, "power": 205, "length": 4.02, "width": 1.8, "height": 1.47, "wheelbase": 2.52, "track": 1.53, "radius": 0.33, "wheelWidth": 0.26, "cg": 0.54, "front": 0.57, "travel": 0.29, "lock": 33, "shape": "rally", "paint": 1473408, "layout": "awd", "grip": 1.06, "dirt": 0.85, "clearance": 0.22, "blurb": "All-wheel punch and short, catchable slides on loose ground."});
const RIBBON_SPEC = identity({"id": "ribbon", "name": "Ribbon R", "category": "Sport", "price": 18000, "mass": 1280, "power": 225, "length": 4.48, "width": 1.83, "height": 1.29, "wheelbase": 2.65, "track": 1.55, "radius": 0.32, "wheelWidth": 0.28, "cg": 0.48, "front": 0.5, "travel": 0.21, "lock": 43, "shape": "liftback", "paint": 9196159, "layout": "rwd", "grip": 0.98, "dirt": 0.7, "clearance": 0.16, "blurb": "Wide steering range and a loose rear. Hold the slide, then countersteer."});
const MERIDIAN_SPEC = identity({"id": "meridian", "name": "Meridian GT", "category": "Sport", "price": 27000, "mass": 1660, "power": 285, "length": 4.86, "width": 1.91, "height": 1.4, "wheelbase": 2.91, "track": 1.63, "radius": 0.35, "wheelWidth": 0.28, "cg": 0.53, "front": 0.54, "travel": 0.23, "lock": 29, "shape": "fastback", "paint": 3165048, "layout": "awd", "grip": 1.03, "dirt": 0.7, "clearance": 0.16, "blurb": "Long, planted and composed. Sweep through fast bends; brake for tight ones."});
const MORROW_SPEC = identity({"id": "morrow", "name": "Morrow 8", "category": "Sport", "price": 30000, "mass": 1740, "power": 320, "length": 4.73, "width": 1.96, "height": 1.34, "wheelbase": 2.77, "track": 1.65, "radius": 0.35, "wheelWidth": 0.3, "cg": 0.55, "front": 0.59, "travel": 0.24, "lock": 30, "shape": "muscle", "paint": 14065978, "layout": "rwd", "grip": 0.91, "dirt": 0.7, "clearance": 0.16, "blurb": "Big low-end shove, heavy nose and a squirming rear. Leave braking room."});
const GT_SPEC = identity({"id": "gt", "name": "Ember RS", "category": "Track", "price": 42000, "mass": 1240, "power": 320, "length": 4.38, "width": 1.94, "height": 1.12, "wheelbase": 2.62, "track": 1.65, "radius": 0.34, "wheelWidth": 0.3, "cg": 0.41, "front": 0.44, "travel": 0.17, "lock": 28, "shape": "supercar", "paint": 13855106, "layout": "rwd", "grip": 1.22, "dirt": 0.65, "clearance": 0.12, "blurb": "Low mid-engine wedge. Precise at speed; respect an abrupt lift."});
const NEEDLE_SPEC = identity({"id": "needle", "name": "Needle 01", "category": "Track", "price": 54000, "mass": 710, "power": 300, "length": 4.55, "width": 1.94, "height": 1.03, "wheelbase": 2.88, "track": 1.6, "radius": 0.32, "wheelWidth": 0.34, "cg": 0.32, "front": 0.44, "travel": 0.13, "lock": 24, "shape": "openwheel", "paint": 13226712, "layout": "rwd", "grip": 1.35, "dirt": 0.65, "clearance": 0.1, "blurb": "Exposed wheels and featherweight response. Grip builds with speed."});
