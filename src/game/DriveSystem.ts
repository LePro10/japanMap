...
export class DriveSystem implements System, FlyInputDelegate, Ground {
  ...
  init(context: EngineContext): void {
    ...
    // Spielerkarte — bewusst als DOM/Canvas neben der 3D-Welt. Eine zweite
    // Three-Kamera würde Gelände, LOD und Vegetation ein zweites Mal bezahlen.
    // Der Weltmarker selbst ist dagegen ein einziges Mesh und damit genau ein
    // zusätzlicher Draw-Call, solange ein Waypoint gesetzt ist.
  ...
  /**
   * Karten-Teleport: nahe an einer Straße auf deren Mittellinie, sonst exakt
   * auf den geklickten Geländepunkt. `placeAt` ist absichtlich der einzige Weg
   * zum Absetzen — dort werden Fahrbahnhöhe, Federung und Geschwindigkeit
